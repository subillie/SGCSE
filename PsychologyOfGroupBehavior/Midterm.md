...
CH01 [집단역학의 소개](CH01-집단역학의-소개)  
	1-1 [집단의 본질](집단의-본질)  
	1-2 [집단역학의 본질](집단역학의-본질)  
	1-3 [집단을 연구하는 이유](집단을-연구하는-이유)  
...
|시간에 걸친 과정과 진전|대부분의 집단에서 동일한 종류의 쟁점들이 시간에 걸쳐서 야기되고, 일단 해결되면 집단과 구성원들의 성질을 더욱 변화시키는 새로운 과정이 시작됨|
|---|:---|
...
## 집단을 연구하는 이유
### 사람 이해
- `기본적 귀인 오류` : 개인에만 집중하는 경향 -> 집단 수준의 영향을 부각시키는 설명에 저항
- 사람들은 집단의 일분일 때 다르게 행동 (동기, 정서, 수행 등)
